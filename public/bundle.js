...
exports.default = addAgeDiv;

var _getPupilAge = require('./getPupilAge');

var _getPupilAge2 = _interopRequireDefault(_getPupilAge);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function addAgeDiv(dob, age) {
	age.textContent = (0, _getPupilAge2.default)(dob);
	var pupilAge = document.importNode(age, true);
	return pupilAge;
}

},{"./getPupilAge":11}],3:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.default = addStartDate;
...
exports.default = addTodayDate;
var moment = require('moment');
function addTodayDate() {
	var dateDiv = document.createElement('h2');
	dateDiv.setAttribute('class', 'date');
	dateDiv.textContent = moment().format('dddd MMMM Do YYYY');
	var titleDate = document.getElementById('pageTitle');
...
var _dailyRegister = require('./dailyRegister');

var _dailyRegister2 = _interopRequireDefault(_dailyRegister);

var _dayWaiting = require('./dayWaiting');

var _dayWaiting2 = _interopRequireDefault(_dayWaiting);

var _fetchPupilRecords = require('./fetchPupilRecords.js');

var _fetchPupilRecords2 = _interopRequireDefault(_fetchPupilRecords);

var _filterStatus = require('./filterStatus');

var _filterStatus2 = _interopRequireDefault(_filterStatus);

var _getTemplate = require('./getTemplate');

var _getTemplate2 = _interopRequireDefault(_getTemplate);

var _pupilRecordsToArray = require('./pupilRecordsToArray');

var _pupilRecordsToArray2 = _interopRequireDefault(_pupilRecordsToArray);

var _spacesRowElements = require('./spacesRowElements');

var _spacesRowElements2 = _interopRequireDefault(_spacesRowElements);

var _makeDay = require('./makeDay');

var _makeDay2 = _interopRequireDefault(_makeDay);

var _addTodayDate = require('./addTodayDate');

var _addTodayDate2 = _interopRequireDefault(_addTodayDate);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _fetchPupilRecords2.default)().then(function (pupils) {
	(0, _getTemplate2.default)();
	(0, _addTodayDate2.default)();
	_stateObject.state.pupilRecordsArray = (0, _pupilRecordsToArray2.default)(pupils);
	_stateObject.state.active = (0, _filterStatus2.default)(_stateObject.state.pupilRecordsArray, 'Active');
	_stateObject.state.waiting = (0, _filterStatus2.default)(_stateObject.state.pupilRecordsArray, 'Waiting');
	_stateObject.state.days.forEach(function (day) {
		var todayReg = (0, _dailyRegister2.default)(day, _stateObject.state.active);
		var todayWait = (0, _dailyRegister2.default)(day, _stateObject.state.waiting);
		(0, _makeDay2.default)(todayReg, day);
		(0, _dayWaiting2.default)(todayWait);
	});
	(0, _spacesRowElements2.default)();
});

},{"./addTodayDate":4,"./dailyRegister":6,"./dayWaiting":7,"./fetchPupilRecords.js":8,"./filterStatus":9,"./getTemplate":12,"./makeDay":13,"./pupilRecordsToArray":14,"./spacesRowElements":15,"./stateObject":16}],6:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.default = dailyRegister;
function dailyRegister(day, status) {
	var dayReg = status.filter(function (pup) {
...
exports.default = dayWaiting;

var _stateObject = require('./stateObject');

var _getFNames = require('./getFNames');

var _getFNames2 = _interopRequireDefault(_getFNames);
...
function dayWaiting(todayWaiting) {
	var waitingNames = (0, _getFNames2.default)(todayWaiting);
	var temp = (0, _tableRowContent2.default)(waitingNames);
	var header = _stateObject.state.tableParts.dayHead;
	header.textContent = null;
	var tab = document.importNode(temp, true);
	document.getElementsByClassName('waiting')[0].appendChild(tab);
}

},{"./getFNames":10,"./stateObject":16,"./tableRowContent":17}],8:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.default = fetchPupilRecords;
...
function filterStatus(pupilRecordsArray, filterBy) {
	if ((0, _toType2.default)(pupilRecordsArray) !== 'array') {
		throw new TypeError('Expected array, got ' + (0, _toType2.default)(pupilRecordsArray));
	}

	var filteredList = pupilRecordsArray.filter(function (p) {
		return p.status === filterBy;
	});
	return filteredList;
}

},{"./toType":18}],10:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.default = getFNames;
...
function getFNames(dayReg) {
	console.log(dayReg);
	if ((0, _toType2.default)(dayReg) !== 'array') {
...
},{"./toType":18}],11:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.default = getPupilAge;
var moment = require('moment');
...
function getTemplate() {
	var dayColumn = document.getElementById('dayColumn');
	var pupilAge = document.getElementById('pupilAge');
	_stateObject.state.tableParts.age = pupilAge.content.querySelector('.age');
	_stateObject.state.tableParts.dayBox = dayColumn.content.querySelector('.dayBox');
	_stateObject.state.tableParts.dayRow = _stateObject.state.tableParts.dayBox.querySelectorAll('.dayRow');
	_stateObject.state.tableParts.dayHead = _stateObject.state.tableParts.dayBox.querySelector('#dayHeading');
}

},{"./stateObject":16}],13:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.default = makeDay;
...
function makeDay(todayReg, day) {
	if ((0, _toType2.default)(todayReg) !== 'array') {
		throw new TypeError('arg 1 needs to be an array');
	}
	var todayNames = (0, _getFNames2.default)(todayReg);
	_stateObject.state.spaces[day] = 8 - todayNames.length;
	var header = _stateObject.state.tableParts.dayHead;
	header.textContent = day;
	var temp = (0, _tableRowContent2.default)(todayNames);
	var tab = document.importNode(temp, true);
	tab.id = day;
	document.getElementsByClassName('timeTable')[0].appendChild(tab);
}

},{"./getFNames":10,"./stateObject":16,"./tableRowContent":17,"./toType":18}],14:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.default = pupilRecordsToArray;
...
function pupilRecordsToArray(pupilRecord) {
	if ((0, _toType2.default)(pupilRecord) !== 'object') {
		throw new TypeError('Expected object, got ' + (0, _toType2.default)(pupilRecord));
	}
...
},{"./toType":18}],15:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.default = spacesRowElements;
...
function spacesRowElements() {
	_stateObject.state.days.forEach(function (day) {
		...
		numberDiv.textContent = _stateObject.state.spaces[day];
		var spaces = document.getElementsByClassName('spaces')[0];
		spaces.appendChild(numberDiv);
	});
}

},{"./stateObject":16}],16:[function(require,module,exports){
'use strict';
...
var _addStartDate = require('./addStartDate');

var _addStartDate2 = _interopRequireDefault(_addStartDate);

var _addAgeDiv = require('./addAgeDiv');

var _addAgeDiv2 = _interopRequireDefault(_addAgeDiv);
...
function tableRowContent(todayNames) {
	var temp = _stateObject.state.tableParts.dayBox;
	var nameDiv = temp.querySelectorAll('.nameAge');
	var starter = temp.querySelectorAll('.starter');
	for (var i = 0; i < 8; i++) {
		todayNames[i] !== undefined ? (nameDiv[i].textContent = todayNames[i].fname, nameDiv[i].id = todayNames[i].key, nameDiv[i].appendChild((0, _addAgeDiv2.default)(todayNames[i].dob, _stateObject.state.tableParts.age)), todayNames[i].status === 'Waiting' ? starter[i].appendChild((0, _addStartDate2.default)(todayNames[i].start)) : starter[i].textContent = null) : (nameDiv[i].textContent = null, nameDiv[i].removeAttribute('id'));
	}
	return temp;
}

},{"./addAgeDiv":2,"./addStartDate":3,"./stateObject":16}],18:[function(require,module,exports){
'use strict';
