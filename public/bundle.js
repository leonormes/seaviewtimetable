...
(0, _fetchPupilRecords2.default)().then(function (pupils) {
	...
	active = (0, _filterStatus2.default)(_stateObject.state.pupilRecordsArray, 'Active');
	waiting = (0, _filterStatus2.default)(_stateObject.state.pupilRecordsArray, 'Waiting');
...
function tableRowContent(todayNames) {
	...
	for (var i = 0; i < 8; i++) {
		if (todayNames[i]) {
			...
			nameDiv[i].appendChild(addAgeDiv(todayNames[i].dob, _stateObject.state.tableParts.age));
...
},{"./fetchPupilRecords.js":3,"./filterStatus":4,"./getFNames":5,"./getTemplate":6,"./pupilRecordsToArray":7,"./stateObject":8,"moment":1}],3:[function(require,module,exports){
'use strict';
...
},{"./stateObject":8}],7:[function(require,module,exports){
"use strict";
