...
function getFNames(dayReg) {
	if ((0, _toType2.default)(dayReg) !== 'array') {
		throw new TypeError('Expected array, got ' + (0, _toType2.default)(dayReg));
	}
	var names = [];
...
},{"./getFNames":10,"./stateObject":16,"./tableRowContent":17}],14:[function(require,module,exports){
'use strict';
